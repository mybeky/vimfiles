...
" #4B8DD2 - VL.BLUE Visual, Current StatusLine & AutoComplete selection
" #808080 - Line numbers
...
hi Visual  guifg=#FFFFFF guibg=#4B8DD2 ctermbg=189
...
hi PmenuSel  guifg=#FFFFFF guibg=#4B8DD2 ctermbg=189
hi Directory  guifg=#D51015 ctermfg=160 gui=bold
hi Folded  guifg=#0066FF ctermfg=27 guibg=#FFFFFF ctermbg=15
" StatusLine: {{{2
hi StatusLine  guifg=#FFFFFF ctermfg=0 guibg=#4B8DD2 ctermbg=189 gui=italic
